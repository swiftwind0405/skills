...
description: First-time setup flow for articles-translates preferences
---
...
options:
  - label: "User (Recommended)"
    description: "$HOME/.articles-translates/ (all projects)"
  - label: "Project"
    description: ".articles-translates/ (this project only)"
```
...
| Choice  | Path                                   | Scope           |
| ------- | -------------------------------------- | --------------- |
| User    | `$HOME/.articles-translates/EXTEND.md` | All projects    |
| Project | `.articles-translates/EXTEND.md`       | Current project |
...
style:
  [
    storytelling/formal/technical/literal/academic/business/humorous/conversational/elegant,
  ]
