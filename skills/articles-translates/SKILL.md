...
| Priority | Path                                                              | Scope     |
| -------- | ----------------------------------------------------------------- | --------- |
| 1        | `.articles-translates/EXTEND.md`                                  | Project   |
| 2        | `${XDG_CONFIG_HOME:-$HOME/.config}/articles-translates/EXTEND.md` | XDG       |
| 3        | `$HOME/.articles-translates/EXTEND.md`                            | User home |
